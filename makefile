...
RUN_REMOTE_BROWSER=export BROWSER_NAME=$(DOCKER_BROWSER) && export HOST_NAME=$(DOCKER_HOSTNAME) && export CUCUMBER_TAGS_EXPRESSION=$(CUCUMBER_TAGS)
RUN_CHROME_BROWSER_GUI=export BROWSER_NAME=$(CHROME_BROWSER_GUI) && export HOST_NAME=$(LOCAL_HOSTNAME) && export CUCUMBER_TAGS_EXPRESSION=$(CUCUMBER_TAGS)
RUN_CHROME_BROWSER_HEADLESS=export BROWSER_NAME=$(CHROME_BROWSER_HEADLESS) && export HOST_NAME=$(LOCAL_HOSTNAME) && export CUCUMBER_TAGS_EXPRESSION=$(CUCUMBER_TAGS)
